...
import { useClerk, useUser,PricingTable  } from '@clerk/react';
import { Image,Eraser, FileText, Hash, House, Scissors, SquarePen, Users, LogOut } from 'lucide-react';
...
const Sidebar = ({sidebar,setSidebar}) => {
    ...
    useEffect(() => {
      const checkPlan = async () => {
        const result = await has({ plan: "premium" });
        setIsPremium(result);
  ...
  return (
    ...
    >
        ...
        <div className='gap-3'>
          ...
          {!isPremium?<p>FREE PLAN</p>:
              <p plan='premium' fallback="free">PREMIUM PLAN</p>
          }   
            </span>
        </div>
    <LogOut
