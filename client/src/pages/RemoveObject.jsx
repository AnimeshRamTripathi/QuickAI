...
const onSubmitHandler=async(e) => {
  ...
  try {
    ...
    {
      return toast('Please eneter only one object name')
    }
...
className='w-full p-2 px-3 mt-2 outline-1 text-sm rounded-md border border-gray-400 text-gray-900  '
placeholder='The future of artificial intelligence is...'
required
/>
<p className='mt-6 text-sm font-medium'>Describle the object name to remove</p>
<textarea onChange={(e)=>{
...
</div>):(<img src={content} alt="image" className='mt-3 w-full h-full'></img>)
    }
</div>  
